		...
		<div className='max-w-4xl m-auto bg-primary rounded-lg'>
			<div className='md:p-10 p-8'>
				...
				<div className='text-center'>
					...
					freshwater algal diversity. It provides the greatest
					opportunity study of biodiversity, ecology and its
					applications in various fields.
				</div>
				<br />
				<div className='text-center'>
					Currently we are focusing and carrying out research in the
					area of:
				</div>
				<br />
					...
					<div className='md:grid md:grid-rows-1 text-black font-semibold md:grid-flow-col'>
						...
						<div className='bg-gray-200  rounded-lg m-4  p-5 transition duration-500 ease-in-out hover:bg-yellow-500 transform hover:-translate-y-1 hover:scale-110'>
							...
							<p className='font-semibold text-base'>
								...
								several districts of Tamil Nadu.
							</p>
						</div>
					</div>
					<div className='md:grid md:grid-rows-1 md:grid-flow-col  text-black font-semibold'>
						...
						<div className='bg-gray-200  rounded-lg m-4 p-5 transition duration-500 ease-in-out hover:bg-yellow-500 transform hover:-translate-y-1 hover:scale-110'>
							...
							<p className='font-semibold text-base'>
								...
								evaluate the potential role of microalgae in
								Pharmaceuticals.
							</p>
						</div>
					</div>
