		...
		<div className='max-w-4xl py-10 p-5 m-auto bg-primary rounded-lg'>
			...
			<div className='p-12'>
				<ul className='list-disc'>
					...
					<li className='border-white bg-gray-200 font-semibold text-gray-800  rounded-b-lg p-5 transition duration-700 ease-in-out hover:bg-yellow-500 hover:rounded-t-lg transform hover:-translate-y-1 hover:scale-110 '>
