function Publications() {
	return (
		<div className='max-w-4xl py-10 p-5 m-auto bg-primary rounded-lg'>
			...
			<div className='p-12'>
				<ul class='list-none pt-0'>
					<li class='border-white bg-gray-200 font-semibold text-gray-800 rounded-t-lg  p-5 transition duration-500 ease-in-out hover:bg-yellow-500 transform hover:-translate-y-1 hover:scale-110 hover:rounded-b-lg'>
					...
					<li class='border-white bg-gray-400  font-semibold text-gray-800 rounded-b-lg p-5 transition duration-500 ease-in-out hover:bg-yellow-500 transform hover:-translate-y-1 hover:scale-110 hover:rounded-t-lg'>
						Jiunn-Tzong Wu, Bakthavachalam Babu, Chuan-Ling Chou and
			...
			<div class='p-12'>
				<ul class='list-disc'>
					...
					<li class='border-white bg-gray-400  font-semibold text-gray-800  p-5 transition duration-500 ease-in-out hover:bg-yellow-500 transform hover:-translate-y-1 hover:scale-110 hover:rounded-lg'>
					...
					<li class='border-white bg-gray-200 font-semibold text-gray-800 p-5 transition duration-500 ease-in-out hover:bg-yellow-500 transform hover:-translate-y-1 hover:scale-110 hover:rounded-lg'>
					...
					<li class='border-white bg-gray-200 font-semibold text-gray-800  rounded-b-lg p-5 transition duration-700 ease-in-out hover:bg-yellow-500 hover:rounded-t-lg transform hover:-translate-y-1 hover:scale-110 '>
